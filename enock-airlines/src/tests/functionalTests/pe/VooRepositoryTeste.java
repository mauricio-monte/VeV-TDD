...
public class VooRepositoryTeste {
    ...
    @Test
    public void CT3FiltrarVoosPorOrigem(){
        construirRepositorioCom3Voos();
    ...
    @Test
    public void CT4FiltrarVoosPorDestino(){
        construirRepositorioCom3Voos();
    ...
    @Test
    public void CT5FiltrarVoosPorData(){
        construirRepositorioCom3Voos();
    ...
    @Test
    public void CT6FiltrarVoosPorHorario(){
        construirRepositorioCom3Voos();
        ...
        assertEquals(LISTA6, vooRepository.getStringVooPorHorario("10:00", "12:00"));
    }

    @Test
    public void CT7FiltrarVoosPorPreco(){
        construirRepositorioCom3Voos();

        Voo voo1 = new Voo( "Origem A", "Destino D", "21/08/2023", "14:00", 300.0);
        Voo voo2 = new Voo( "Origem A", "Destino E", "20/08/2023", "10:00", 200.0);

        vooRepository.adicionarVoo(voo1);
        vooRepository.adicionarVoo(voo2);

        assertEquals(LISTA6, vooRepository.getStringVooPorPreco(201.0));
    }

    @Test
    public void CT8FiltrarVoosPorVagasMinimas(){
